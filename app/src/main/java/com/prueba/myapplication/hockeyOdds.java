 ...
 */
public class hockeyOdds extends Fragment implements PlayerCallback {
    ...
    public void onResume(){
        super.onResume();
        PlayerManager.getInstance(getActivity().getApplicationContext()).getApuestasByleagueNameBasket(hockeyOdds.this, nombreLeague);
    }
