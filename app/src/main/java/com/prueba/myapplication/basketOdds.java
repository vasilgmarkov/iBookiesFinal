 ...
 */
public class basketOdds extends Fragment implements PlayerCallback {
    ...
    public void onResume(){
        super.onResume();
        PlayerManager.getInstance(getActivity().getApplicationContext()).getApuestasByleagueNameBasket(basketOdds.this, nombreLeague);
    }
