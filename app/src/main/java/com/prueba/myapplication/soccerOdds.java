 ...
 */
public class soccerOdds extends Fragment implements PlayerCallback {
    ...
    public void onResume(){
        ...
        PlayerManager.getInstance(getActivity().getApplicationContext()).getApuestasByleagueName(soccerOdds.this, nombreLeague);
    }
