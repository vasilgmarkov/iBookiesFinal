 ...
 */
public class BlankFragment1 extends Fragment implements PlayerCallback {
    ...
    public void onResume(){
        ...
        PlayerManager.getInstance(getActivity().getApplicationContext()).getApuestasByleagueName(BlankFragment1.this, nombreLeague);
    }
