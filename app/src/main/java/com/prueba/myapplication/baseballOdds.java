 ...
 */
public class baseballOdds extends Fragment implements PlayerCallback {
    ...
    public void onResume(){
        super.onResume();
        PlayerManager.getInstance(getActivity().getApplicationContext()).getApuestasByleagueNameBasket(baseballOdds.this, nombreLeague);
    }
